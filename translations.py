translations = {
    'en': {
        ...
        'select_language': "Select language (en/it): ",
        'menu_prompt': "It's not a command!",
        'exit_message': "\nI hope to see you soon - 73 de IZ4APU TU EE",
        'hpe_cuagn': "hpe cuagn - 73 de iz4apu tu e e",
        ...
        'press_m_for_menu': "\nCWAPU - VERSION: {version} BY GABE - IZ4APU.\n----UTILITIES FOR YOUR CW----\n\t\tPress 'm' for menu.",
        # Aggiungi altre stringhe necessarie
    },
    'it': {
        'welcome_message': "\nCWAPU - VERSIONE: {version} DI GABE - IZ4APU.\n----UTILITÀ PER IL TUO CW----\n\t\tPremi 'm' per il menu.",
        'select_language': "Seleziona la lingua (en/it): ",
        'menu_prompt': "Non è un comando!",
        'exit_message': "\nSpero di rivederti presto - 73 de IZ4APU TU EE",
        'hpe_cuagn': "spero di rivederti - 73 de iz4apu tu e e",
